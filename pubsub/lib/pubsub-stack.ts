...
export class pubsubStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const ggRoleArn =
      "arn:aws:iam::144932442613:role/GreengrassV2TokenExchangeRole";

    const ggBucket = new s3.Bucket(this, "ggBucket");

    const componentDeployment = new s3deploy.BucketDeployment(
      this,
      "componentDeployment",
      {
    ...
    const componentRecipe = fs
      .readFileSync("./lib/component/recipe.yml", {
        encoding: "utf-8",
      })
    ...
    const pubsubComponent = new gg.CfnComponentVersion(
      this,
      "PubsubComponent",
      {
